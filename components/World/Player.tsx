...
export const Player: React.FC = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener('control-ability', handleControlAbility);
    ...
    return () => {
        ...
        window.removeEventListener('control-ability', handleControlAbility);
    };
  ...
  useEffect(() => {
    ...
    const handleTouchEnd = (e: TouchEvent) => {
        ...
        // Swipe Detection - kept as fallback/alternative
